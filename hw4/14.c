...
list* get_list() {
    ...
    int len = 0;
/////////////////////////////////////
//сохранение первого слова в список//
/////////////////////////////////////
    ok = scanf("%c", &c);
    while (c == ' ')
        ok = scanf("%c", &c);
    ...
    ptr1->next = NULL;
//////////////////////////////////////////
//преобразование списка в строку и      // 
//добавление строки в начало осн. списка// 
//////////////////////////////////////////
    ...
    if (strcmp(str, "")) {
        ...
        free(str);
////////////////////////////////////////////////////////
//в цикле записываем остальные слова в основной список//
////////////////////////////////////////////////////////
    while (c != '\n' && ok != -1) {
        len = 0;
        head1 = malloc(sizeof(word));
